...
const AIChat: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: 'model', text: 'Pronto para transcender? Pergunte à LUMI qualquer coisa sobre o festival. ⚡️' }
  ]);
          ...
          >
            ...
            <div className="bg-gradient-to-r from-fuchsia-900/50 to-purple-900/50 p-4 flex justify-between items-center border-b border-white/10">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-heading font-bold text-white tracking-wider">LUMI IA</h3>
              </div>
            ...
            <div className="p-3 border-t border-white/10 bg-black/40">
              <div className="flex gap-2">
                <input
                  ...
                  placeholder="Pergunte sobre lineup, ingressos..."
