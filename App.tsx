...
const LINEUP: Artist[] = [
  { 
    ...
    description: 'Arquitetos do abismo audível, tecendo tapeçarias pesadas de sintetizadores que exploram as fronteiras entre a consciência digital e orgânica.'
  },
  { 
    id: '2', 
    name: 'Data Mosh', 
    ...
    description: 'Desconstruindo a batida para reconstruí-la em caos de alta definição. Espere texturas de glitch, ritmos quebrados e pura entropia de áudio.'
  },
  { 
    id: '3', 
    name: 'Ether Real', 
    ...
    description: 'Techno de uma dimensão de pura luz. Loops hipnóticos e vocais etéreos que flutuam sobre uma base de baixo industrial.'
  },
  { 
    id: '4', 
    name: 'Hyper Loop', 
    ...
    description: 'Drum & bass de alta velocidade que acelera os batimentos cardíacos para coincidir com o ritmo do pulso de neon da cidade.'
  },
  { 
    id: '5', 
    name: 'Digital Soul', 
    ...
    description: 'Deep house profundo e ressonante que encontra o fantasma na máquina, misturando samples com alma e design de som futurista.'
  },
  { 
    id: '6', 
    name: 'Void Walker', 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-16 items-center">
            <div className="lg:col-span-5 order-2 lg:order-1">
              ...
              <p className="text-lg md:text-xl text-gray-200 mb-8 md:mb-12 font-light leading-relaxed drop-shadow-md">
                O Lumina não é apenas um festival; é uma expedição sensorial. Fundimos tecnologia de áudio de ponta com arte generativa para criar um ecossistema de som vivo e pulsante.
              </p>
              
              <div className="space-y-6 md:space-y-8">
                {[
                  { icon: Globe, title: 'Distrito Estelar', desc: 'Caminhe entre construções de luz de 15 metros.' },
                  { icon: Zap, title: 'Áudio Neuro-Link', desc: 'Pisos hápticos que sincronizam com seu batimento cardíaco.' },
                  { icon: Music, title: 'Palco Infinito', desc: 'Visuais impulsionados por IA que reagem à multidão.' },
                ].map((feature, i) => (
                  <div
                    key={i} 
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              { name: 'Fim de Semana', price: '$349', color: 'teal', accent: 'bg-[#4fb7b3]/10 border-[#4fb7b3]/50' },
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="space-y-4 md:space-y-6 text-sm text-gray-200">
                      ...
                      {i > 0 && <li className="flex items-center gap-3 text-white"><Zap className={`w-5 h-5 text-[#a8fbd3]`} /> Entrada Rápida</li>}
                      {i > 1 && <li className="flex items-center gap-3 text-white"><Globe className={`w-5 h-5 text-[#4fb7b3]`} /> Lounge nos Bastidores</li>}
                    </ul>
                  </div>
                  ...
                  >
                    <span className="relative z-10">
                      {isPurchasing ? 'Comprando...' : isPurchased ? 'Comprado' : 'Comprar'}
                    </span>
                  ...
                  {isPurchased && (
                    ...
                    >
                      Site demo: nenhuma compra realizada
                    </motion.p>
                  )}
                </motion.div>
              );
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
          <div>
             ...
             <div className="flex gap-2 text-xs font-mono text-gray-400">
               <span>criado por landingpagepro</span>
             </div>
          </div>
          
          <div className="flex gap-6 md:gap-8 flex-wrap">
            <a href="https://x.com/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white font-bold uppercase text-xs tracking-widest transition-colors cursor-pointer" data-hover="true">
              Twitter
            </a>
          </div>
        </div>
